...
const CHAT_CSS = `
.cs-sitechat-banner{display:flex;gap:9px;align-items:flex-start;margin:0 0 12px;border:1px solid rgba(139,92,246,.32);background:rgba(139,92,246,.14);color:#5b4a8f;border-radius:10px;padding:11px 13px;font-size:11.5px;line-height:19px}
...
.cs-sitechat-intro p{margin:0;font-size:11.5px;line-height:19px;color:#94a3b8}
...
.cs-sitechat-who{font-size:10px;font-weight:650;color:#94a3b8;letter-spacing:.02em}
.cs-sitechat-bubble{max-width:82%;background:#0d1526;border:1px solid rgba(255,255,255,.07);border-radius:12px;padding:11px 13px;font-size:12.5px;line-height:20px;white-space:pre-wrap;word-break:break-word}
...
.cs-sitechat-chip{border:1px solid rgba(255,255,255,.09);background:#0b1220;border-radius:20px;padding:7px 12px;font-size:11.5px;color:#cbd5e1}
.cs-sitechat-chip:hover:not(:disabled){background:#0d1526;border-color:#c9cede}
.cs-sitechat-chip:disabled{opacity:.5;cursor:default}
.cs-sitechat-error{margin:0 19px 12px;border:1px solid rgba(244,63,94,.32);background:rgba(244,63,94,.12);color:#fda4af;border-radius:10px;padding:10px 13px;font-size:11.5px}
.cs-sitechat-input{display:flex;gap:9px;padding:14px 19px;border-top:1px solid rgba(255,255,255,.07)}
.cs-sitechat-input input{flex:1;height:38px;border:1px solid rgba(255,255,255,.09);border-radius:9px;padding:0 13px;font-size:12.5px;background:#0b1220;color:#11162d}
.cs-sitechat-input input:focus{outline:2px solid #7c3aed;outline-offset:1px}
.cs-sitechat-input input:disabled{background:#0d1526}
.cs-sitechat-facts{display:flex;flex-direction:column;gap:9px}
.cs-sitechat-facts-head{font-size:10px;font-weight:700;letter-spacing:.07em;text-transform:uppercase;color:#94a3b8;margin-top:8px}
.cs-sitechat-fact{display:flex;justify-content:space-between;gap:12px;align-items:baseline;font-size:11.5px}
.cs-sitechat-fact span{color:#cbd5e1;min-width:0}
