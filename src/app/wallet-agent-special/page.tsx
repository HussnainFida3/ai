    ...
    <div style={{ minHeight: "100vh", background: "#0d1526", padding: "48px 24px", fontFamily: "Inter, ui-sans-serif, system-ui, sans-serif" }}>
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 20 }}>
          <div style={{ border: "1px solid rgba(139,92,246,.32)", borderRadius: 16, background: "#0b1220", padding: 20, boxShadow: "0 2px 10px rgba(25,34,75,0.035)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
              ...
              <span style={{ marginLeft: "auto", fontSize: 10.5, fontWeight: 700, color: "#4ade80", background: "rgba(34,197,94,.13)", border: "1px solid #4ade8033", borderRadius: 6, padding: "3px 8px" }}>
                ✓ Agent registered
              </span>
            </div>
          ...
          <div style={{ border: "1px solid rgba(255,255,255,.07)", borderRadius: 16, background: "#0d1526", padding: 20 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 6 }}>
              ...
              <span style={{ marginLeft: "auto", fontSize: 10.5, fontWeight: 700, color: "#fbbf24", background: "rgba(245,158,11,.13)", border: "1px solid #fbbf2433", borderRadius: 6, padding: "3px 8px" }}>
                ⚠ Not registered
              </span>
            </div>
            <p style={{ fontSize: 11.5, color: "#94a3b8", margin: "0 0 14px", lineHeight: 1.6 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {PAGES.map((page) => (
                <Link
                  ...
                  style={{ display: "block", padding: "12px 14px", borderRadius: 10, border: "1px dashed #e2e5ee", textDecoration: "none", color: "#94a3b8" }}
                >
