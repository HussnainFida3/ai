...
.cs-analytics-intro p{margin:6px 0 0;font-size:11.5px;line-height:19px;color:#94a3b8}
...
.cs-analytics-who{font-size:10px;font-weight:650;color:#94a3b8}
.cs-analytics-bubble{background:#0d1526;border:1px solid rgba(255,255,255,.07);border-radius:13px 13px 13px 4px;padding:11px 14px;font-size:12px;line-height:20px;color:#f1f5f9;white-space:pre-wrap;word-break:break-word}
...
.cs-analytics-chips{display:flex;flex-wrap:wrap;gap:7px;padding:12px 19px 0;border-top:1px solid rgba(255,255,255,.07)}
.cs-analytics-chip{display:inline-flex;align-items:center;gap:6px;height:30px;padding:0 11px;border-radius:999px;border:1px solid rgba(255,255,255,.07);background:#0b1220;color:#cbd5e1;font-size:11px;font-weight:600}
.cs-analytics-chip:hover:not(:disabled){background:rgba(139,92,246,.14);border-color:rgba(139,92,246,.45);color:#c4b5fd}
...
.cs-analytics-input input{flex:1;height:40px;border:1px solid rgba(255,255,255,.09);border-radius:10px;padding:0 13px;font-size:12px;background:#0b1220;outline:0}
.cs-analytics-input input:focus{border-color:#8b5cf6}
.cs-analytics-input input:disabled{background:#0d1526;color:#94a3b8}
...
.cs-analytics-facts-head{font-size:10.5px;font-weight:650;color:#94a3b8;margin-top:14px;padding-bottom:4px}
.cs-analytics-chat-note{margin:12px 0 0;font-size:11px;line-height:18px;color:#94a3b8}
`;
