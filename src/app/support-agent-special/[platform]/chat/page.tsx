...
.cs-support-intro p{margin:0;font-size:11.5px;line-height:19px;color:#94a3b8}
...
.cs-support-who{font-size:10px;font-weight:650;color:#94a3b8;letter-spacing:.02em}
.cs-support-bubble{max-width:82%;background:#0d1526;border:1px solid rgba(255,255,255,.07);border-radius:12px;padding:11px 13px;font-size:12.5px;line-height:20px;white-space:pre-wrap;word-break:break-word}
...
.cs-support-chip{border:1px solid rgba(255,255,255,.09);background:#0b1220;border-radius:20px;padding:7px 12px;font-size:11.5px;color:#cbd5e1}
.cs-support-chip:hover:not(:disabled){background:#0d1526;border-color:#c9cede}
.cs-support-chip:disabled{opacity:.5;cursor:default}
.cs-support-error{margin:0 19px 12px;border:1px solid rgba(244,63,94,.32);background:rgba(244,63,94,.12);color:#fda4af;border-radius:10px;padding:10px 13px;font-size:11.5px}
.cs-support-input{display:flex;gap:9px;padding:14px 19px;border-top:1px solid rgba(255,255,255,.07)}
.cs-support-input input{flex:1;height:38px;border:1px solid rgba(255,255,255,.09);border-radius:9px;padding:0 13px;font-size:12.5px;background:#0b1220;color:#11162d}
.cs-support-input input:focus{outline:2px solid #7c3aed;outline-offset:1px}
.cs-support-input input:disabled{background:#0d1526}
.cs-support-facts{display:flex;flex-direction:column;gap:9px}
.cs-support-facts-head{font-size:10px;font-weight:700;letter-spacing:.07em;text-transform:uppercase;color:#94a3b8;margin-top:8px}
.cs-support-fact{display:flex;justify-content:space-between;gap:12px;align-items:baseline;font-size:11.5px}
.cs-support-fact span{color:#cbd5e1;min-width:0}
.cs-support-fact b{font-weight:730;white-space:nowrap}
.cs-support-note{margin:10px 0 0;font-size:10.5px;line-height:17px;color:#94a3b8}
`;
