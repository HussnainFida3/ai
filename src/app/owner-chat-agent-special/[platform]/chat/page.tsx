...
.cs-owner-intro p{margin:0;font-size:11.5px;line-height:19px;color:#69738c}
.cs-owner-turn{display:flex;flex-direction:column;gap:5px;align-items:flex-start}
.cs-owner-turn-user{align-items:flex-end}
.cs-owner-who{font-size:10px;font-weight:650;color:#69738c;letter-spacing:.02em}
.cs-owner-bubble{max-width:82%;background:#f5f6fa;border:1px solid #eef0f5;border-radius:12px;padding:11px 13px;font-size:12.5px;line-height:20px;white-space:pre-wrap;word-break:break-word}
...
.cs-owner-chip{border:1px solid #dfe2ea;background:#fff;border-radius:20px;padding:7px 12px;font-size:11.5px;color:#4c5470}
.cs-owner-chip:hover:not(:disabled){background:#f7f8fc;border-color:#c9cede}
.cs-owner-chip:disabled{opacity:.5;cursor:default}
.cs-owner-chat-error{margin:0 19px 12px;border:1px solid #f6d5d8;background:#fff5f5;color:#a32732;border-radius:10px;padding:10px 13px;font-size:11.5px}
.cs-owner-input{display:flex;gap:9px;padding:14px 19px;border-top:1px solid #eef0f5}
.cs-owner-input input{flex:1;height:38px;border:1px solid #dfe2ea;border-radius:9px;padding:0 13px;font-size:12.5px;background:#fff;color:#11162d}
.cs-owner-input input:focus{outline:2px solid #7c3aed;outline-offset:1px}
.cs-owner-input input:disabled{background:#f7f8fc}
.cs-owner-facts{display:flex;flex-direction:column;gap:9px}
.cs-owner-facts-head{font-size:10px;font-weight:700;letter-spacing:.07em;text-transform:uppercase;color:#8891a8;margin-top:8px}
.cs-owner-fact{display:flex;justify-content:space-between;gap:12px;align-items:baseline;font-size:11.5px}
.cs-owner-fact span{color:#4c5470;min-width:0}
.cs-owner-fact b{font-weight:730;white-space:nowrap}
.cs-owner-warn{margin:0;border:1px solid #f2dfb4;background:#fffaf0;border-radius:9px;padding:9px 11px;font-size:11px;line-height:18px;color:#7a5410}
.cs-owner-chat-note{margin:10px 0 0;font-size:10.5px;line-height:17px;color:#8891a8}
`;
